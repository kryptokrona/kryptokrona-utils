...
const Self = function () {
  ...
  if (isNode) console.log('Running in node...')
  if (isBrowser) console.log('Running in browser')
}
...
Self.prototype.cnFastHash = Self.prototype.cn_fast_hash
...
Self.prototype.generateKeyDerivation = function (transactionPublicKey, privateViewKey) {
  console.log(transactionPublicKey, privateViewKey)
