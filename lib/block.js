...
Block.prototype._toHashingBlob = function () {
  ...
  if (this.majorVersion >= this.activateParentBlockVersion) {
    ...
    if (this.parentBlock.baseTransactionBranch.length !== 0) {
      branches.push(this.parentBlock.baseTransactionBranch)
    }

    const [parentErr, parentTreeHash] = crypto.tree_hash_from_branch(branches, this.parentBlock.minerTransaction.hash, 0)
...
Block.prototype._fromBlob = function (blob) {
  ...
  if (this.majorVersion >= this.activateParentBlockVersion) {
    ...
    if (this.parentBlock.minerTransaction.version >= 2) {
      ...
      if (this.parentBlock.minerTransaction.outputs.length === 1) {
        this.parentBlock.baseTransactionBranch = reader.nextHash()
      }
    }
  }
...
Block.prototype._toBlob = function () {
  ...
  if (this.majorVersion >= this.activateParentBlockVersion) {
    ...
    if (this.parentBlock.minerTransaction.version >= 2) {
      if (this.parentBlock.minerTransaction.ignoredField !== false) {
