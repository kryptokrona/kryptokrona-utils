...
class Block {
   ...
   * @constructs
   * @param {string|BlockConfig} [hexData] - the hexadecimal representation of an existing block or a configuration object
   * @param {BlockConfig} [opts] - a configuration object
   */
